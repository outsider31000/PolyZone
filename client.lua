...
function PolyZone:draw(forceDraw)
    ...
    for i = 1, #points do
        ...
        if i < #points then
            ...
            DrawLine(point.x, point.y, minZ, p2.x, p2.y, minZ, oR, oG, oB, 184)
...
function DrawLine(minX, minY, minZ, maxX, maxY, maxZ, r, g, b, a)
    Citizen.InvokeNative(0xB856A90, minX, minY, minZ, maxX, maxY, maxZ, r, g, b, a)
end
